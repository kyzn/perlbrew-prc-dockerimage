...
ENV PERLBREW_PATH=/root/perl5/perlbrew/bin:/root/perl5/perlbrew/perls/perl-5.28.1/bin
ENV PERLBREW_MANPATH=/root/perl5/perlbrew/perls/perl-5.28.1/man

# Install perlbrew & perl & cpanm
RUN curl -L https://install.perlbrew.pl | bash
RUN echo "source /root/perl5/perlbrew/etc/bashrc" >> /root/.bashrc
RUN /root/perl5/perlbrew/bin/perlbrew install -j 4 perl-5.28.1
RUN /root/perl5/perlbrew/bin/perlbrew switch perl-5.28.1
