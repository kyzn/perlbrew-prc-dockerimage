...
ENV PERLBREW_PATH=/root/perl5/perlbrew/bin:/root/perl5/perlbrew/perls/perl-5.32.1/bin
ENV PERLBREW_MANPATH=/root/perl5/perlbrew/perls/perl-5.32.1/man

# Install perlbrew & perl & cpanm
RUN curl -L https://install.perlbrew.pl | bash
RUN echo "source /root/perl5/perlbrew/etc/bashrc" >> /root/.bashrc
RUN /root/perl5/perlbrew/bin/perlbrew install -j 4 perl-5.32.1
RUN /root/perl5/perlbrew/bin/perlbrew switch perl-5.32.1
...
ENV PATH=/root/perl5/perlbrew/bin:/root/perl5/perlbrew/perls/perl-5.32.1/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
